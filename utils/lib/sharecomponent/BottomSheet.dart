...
class _BottomSheetState extends State<BottomSheet> {
  ...
  void _onVerticalDragUpdate(data) {
    ...
    print('_onVerticalDragUpdate ${widget.controller.height}');
  ...
  void _onVerticalDragEnd(data) {
    ...
    print('_onVerticalDragEnd ${widget.controller.height}');

    if (widget.controller.height < widget.heightToHide) {
      _hide();
      return;
    }

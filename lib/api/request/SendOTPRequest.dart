...
import 'package:trans/api/result/SendOTP.dart';
...
class SendOTPRequest extends BaseRequest {
  ...
  static void callBackgroundRequest(Params params) async {
    ...
    try {
      ...
      /// Call api
      Response response =
          await connector.post('user/send_otp', data: params.data);
      print(response);
      result = Result<SendOTP>();
      result.code = response.statusCode;
      result.data = SendOTP.fromJson(response.data);
    } on DioError catch (e) {

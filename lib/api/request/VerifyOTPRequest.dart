...
import 'package:trans/api/result/VerifyOTP.dart';
...
class VerifyOTPRequest extends BaseRequest {
  ...
  static void callBackgroundRequest(Params params) async {
    ...
    try {
      ...
      /// Call api
      Response response =
          await connector.post('user/verify_opt_code', data: params.data);
      print(response);
      result = Result<VerifyOTP>();
      result.code = response.statusCode;
      result.data = VerifyOTP.fromJson(response.data);
    } on DioError catch (e) {

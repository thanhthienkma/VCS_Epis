...
import 'package:trans/api/result/PhoneLogin.dart';
...
class PhoneRequest extends BaseRequest {
  ...
  static void callBackgroundRequest(Params params) async {
    ...
    try {
      ...
      /// Call api
      Response response =
          await connector.post('user/check_phone_exist', data: params.data);
      print(response);
      result = Result<PhoneLogin>();
      result.code = response.statusCode;
      result.data = PhoneLogin.fromJson(response.data);
    } on DioError catch (e) {

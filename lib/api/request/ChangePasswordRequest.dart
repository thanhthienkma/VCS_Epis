...
import 'package:trans/api/result/ChangePassword.dart';
...
class ChangePasswordRequest extends BaseRequest {
  ...
  static void callBackgroundRequest(Params params) async {
    ...
    try {
      ...
      /// Call api
      Response response =
          await connector.post('user/change_password', data: params.data);
      print(response);
      result = Result<ChangePassword>();
      result.code = response.statusCode;
      result.data = ChangePassword.fromJson(response.data);
    } on DioError catch (e) {

...
import 'package:trans/models/comment_model.dart';
import 'package:trans/screens/news/screens/commentsadd/CommentsAddScreen.dart';
import 'package:trans/utils/NavigateUtil.dart';
import 'package:trans/widgets/comment.dart';
...
import 'package:trans/widgets/no_data.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: DecoNewsAppBar(
          isChangeIcon: false,
          menuCallback: () => NavigateUtil.instance.popScreen(context)),
      body: _buildBody(),
